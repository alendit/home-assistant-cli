...
def _report(ctx: Configuration, cmd: str, method: str, response: Response) -> None:
    """Create a report."""
...
def _handle(
    ctx: Configuration, method: str, httpmethod: str = "get", raw: bool = False
) -> None:
    """Handle the data."""
...
def _handle_raw(
    ctx: Configuration, method: str, httpmethod: str = "get"
) -> Dict[str, Any]:
    """Handle raw data."""
    method = "/api/hassio/" + method
    response = api.restapi(ctx, httpmethod, method)
...
@pass_context
def supervisor(ctx: Configuration) -> None:
...
@pass_context
def supervisor_ping(ctx: Configuration) -> None:
...
@pass_context
def supervisor_info(ctx: Configuration) -> None:
...
@pass_context
def supervisor_update(ctx: Configuration) -> None:
...
@pass_context
def supervisor_options(ctx: Configuration) -> None:
...
@pass_context
def supervisor_reload(ctx: Configuration) -> None:
...
@pass_context
def supervisor_logs(ctx: Configuration) -> None:
...
@pass_context
def supervisor_repair(ctx: Configuration) -> None:
...
@pass_context
def supervisor_stats(ctx: Configuration) -> None:
...
@cli.group("snapshot")
@pass_context
def snapshot(ctx: Configuration) -> None:
...
@pass_context
def snapshot_reload(ctx: Configuration) -> None:
...
@pass_context
def snapshot_shutdown(ctx: Configuration) -> None:
...
@cli.group("host")
@pass_context
def host(ctx: Configuration) -> None:
...
@host.command("reboot")
@pass_context
def host_reboot(ctx: Configuration) -> None:
...
@host.command("reload")
@pass_context
def host_reload(ctx: Configuration) -> None:
...
@pass_context
def host_shutdown(ctx: Configuration) -> None:
    """Home Assistant host shutdown."""
    _handle(ctx, "host/shutdown", "post")
...
@host.command("info")
@pass_context
def host_info(ctx: Configuration) -> None:
...
@pass_context
def host_options(ctx: Configuration) -> None:
...
@pass_context
def host_services(ctx: Configuration) -> None:
    """Home Assistant host reboot."""
...
@os.command("info")
@pass_context
def os_info(ctx: Configuration) -> None:
...
@os.command("update")
@pass_context
def os_update(ctx: Configuration) -> None:
...
@cli.group("hardware")
@pass_context
def hardware(ctx: Configuration) -> None:
...
@pass_context
def hardware_info(ctx: Configuration) -> None:
...
@pass_context
def hardware_audio(ctx: Configuration) -> None:
    """Home Assistant hardware audio."""
...
@pass_context
def hardware_trigger(ctx: Configuration) -> None:
...
@cli.group("addons")
@pass_context
def addons(ctx: Configuration) -> None:
...
@addons.command("all")
@pass_context
def addons_all(ctx: Configuration) -> None:
...
@pass_context
def addons_reload(ctx: Configuration) -> None:
...
@cli.group("core")
@pass_context
def core(ctx: Configuration) -> None:
...
@core.command("info")
@pass_context
def core_info(ctx: Configuration) -> None:
...
@core.command("update")
@pass_context
def core_update(ctx: Configuration) -> None:
...
@core.command("logs")
@pass_context
def core_logs(ctx: Configuration) -> None:
...
@pass_context
def core_restart(ctx: Configuration) -> None:
...
@core.command("check")
@pass_context
def core_check(ctx: Configuration) -> None:
...
@core.command("start")
@pass_context
def core_start(ctx: Configuration) -> None:
...
@core.command("stop")
@pass_context
def core_stop(ctx: Configuration) -> None:
...
@pass_context
def core_rebuild(ctx: Configuration) -> None:
...
@pass_context
def core_options(ctx: Configuration) -> None:
...
@pass_context
def core_websocket(ctx: Configuration) -> None:
...
@core.command("stats")
@pass_context
def core_stats(ctx: Configuration) -> None:
...
@cli.group("dns")
@pass_context
def dns(ctx: Configuration) -> None:
...
@dns.command("info")
@pass_context
def dns_info(ctx: Configuration) -> None:
...
@dns.command("options")
@pass_context
def dns_options(ctx: Configuration) -> None:
...
@dns.command("restart")
@pass_context
def dns_restart(ctx: Configuration) -> None:
...
@dns.command("logs")
@pass_context
def dns_logs(ctx: Configuration) -> None:
...
@dns.command("stats")
@pass_context
def dns_stats(ctx: Configuration) -> None:
...
@cli.group("multicast")
@pass_context
def multicast(ctx: Configuration) -> None:
...
@pass_context
def multicast_info(ctx: Configuration) -> None:
...
@pass_context
def multicast_update(ctx: Configuration) -> None:
...
@pass_context
def multicast_restart(ctx: Configuration) -> None:
...
@pass_context
def multicast_logs(ctx: Configuration) -> None:
    """Home Assistant DNS logs."""
...
@pass_context
def multicast_stats(ctx: Configuration) -> None:
...
@cli.group("ha-cli")
@pass_context
def ha_cli(ctx: Configuration) -> None:
...
@ha_cli.command("info")
@pass_context
def ha_info(ctx: Configuration) -> None:
...
@pass_context
def ha_update(ctx: Configuration) -> None:
...
@pass_context
def ha_restart(ctx: Configuration) -> None:
...
@ha_cli.command("logs")
@pass_context
def ha_logs(ctx: Configuration) -> None:
...
@pass_context
def ha_stats(ctx: Configuration) -> None:
